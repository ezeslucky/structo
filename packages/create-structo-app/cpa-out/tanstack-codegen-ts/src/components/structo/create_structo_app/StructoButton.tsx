...
import sty from "./StructoButton.css?url"; // structo-import: TQcvW_pSKi3/css
  ...
  return (
    <button
      ...
      className={classNames(
        "structo_default__all",
        "structo_default__button",
        "root_reset_47tFXWjN2C4NyHFGGpaYQ3",
        "structo_default_styles",
        "structo_mixins",
        "structo_tokens",
        "Button__root__gpc3K",
        {
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  if (b.structoProps.overrides.root.as === "a") {
    ...
    b.structoProps.overrides.root.props.platform = "tanstack";
  }
  return b;
}
...
export const StructoButton__HeadOptions = {
