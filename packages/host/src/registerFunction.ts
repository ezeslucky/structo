...
declare global {
  interface Window {
    __StructoFunctionsRegistry: CustomFunctionRegistration[];
  }
}

if (root.__StructoFunctionsRegistry == null) {
  root.__StructoFunctionsRegistry = [];
}
...
export default function registerFunction<F extends (...args: any[]) => any>(
  ...
  root.__StructoFunctionsRegistry.push({ function: fn, meta });
}
