...
import { StructoApi, ProjectBundle } from "../api";
import {
...
interface ExportOpts {
  ...
  //@ts-ignore
  platform?: StructoConfig["platform"];
...
async function exportProjects(api: StructoApi, opts: ExportOpts) {
