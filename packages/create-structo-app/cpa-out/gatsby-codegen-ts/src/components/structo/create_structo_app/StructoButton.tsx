...
import * as projectcss from "./structo.module.css"; // plasmic-import: 47tFXWjN2C4NyHFGGpaYQ3/projectcss
import * as sty from "./StructoButton.module.css"; // plasmic-import: TQcvW_pSKi3/css
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  if (b.structoProps.overrides.root.as === "a") {
    ...
    b.structoProps.overrides.root.props.platform = "gatsby";
  }
  return b;
}
