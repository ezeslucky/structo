...
import registerComponent, {
  ...
  ComponentMeta,
} from "@structoapp/host/registerComponent";
import registerGlobalContext, {
  GlobalContextMeta,
} from "@structoapp/host/registerGlobalContext";
import { useStructoQueryData } from "@structoapp/query";
import React from "react";

const defaultHost = "https://studio.structo.app";
...
export function AirtableRecord({
  ...
  const data = useStructoQueryData(
...
export function AirtableCollection({
  ...
  const { data, error, isLoading } = useStructoQueryData(
    JSON.stringify([
      "AirtableCollection",
      host,
      base,
...
export function AirtableCredentialsProvider({
  ...
  const inCanvas = useStructoCanvasContext();
...
const thisModule = "@structopkgs/airtable";
...
export const airtableCredentialsProviderMeta: GlobalContextMeta<AirtableCredentialsProviderProps> = {
  ...
  props: {
    ...
    host: {
      type: "string",
      displayName: "Host",
      description: "Structo Server-Data URL",
