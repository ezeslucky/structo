...
export const DEFAULT_HOST =
  process.env.STRUCTO_DEFAULT_HOST || "https://studio.structo.app";

// Default filenames
export const AUTH_FILE_NAME = ".structo.auth";
export const CONFIG_FILE_NAME = "structo.json";
export const LOCK_FILE_NAME = "structo.lock";
export const CONFIG_SCHEMA_FILE_NAME = "structo.schema.json";

// Default environment variable names
export const ENV_AUTH_HOST = "STRUCTO_AUTH_HOST";
export const ENV_AUTH_USER = "STRUCTO_AUTH_USER";
export const ENV_AUTH_TOKEN = "STRUCTO_AUTH_TOKEN";

export interface StructoConfig {
 ...
 * created.
 */
export interface StructoContext {
...
export const DEFAULT_CONFIG: StructoConfig = {
  platform: "react",
  code: {
    lang: "ts",
    scheme: "blackbox",
...
export function fillDefaults(
  config: DeepPartial<StructoConfig>
): StructoConfig {
...
export function readConfig(
  ...
  if (!existsBuffered(configFile)) {
    const err = new HandledError(
      `No Structo config file found at ${configFile}`
    );
    throw err;
  }
  try {
    const result = JSON.parse(readFileText(configFile!)) as StructoConfig;
