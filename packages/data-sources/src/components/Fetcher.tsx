...
import { useStructoDataOp } from "../hooks/useStructoDataOp";
...
export function Fetcher(props: FetcherProps): React.ReactElement | null {
  ...
  const data = useStructoDataOp(dataOp, {
    ...(!!pageIndex &&
      !!pageSize && {
...
export const FetcherMeta: ComponentMeta<FetcherProps> = {
  name: "structo-data-source-fetcher",
  ...
  importPath: "@structoapp/react-web/lib/data-sources",
  importName: "Fetcher",
  alwaysAutoName: true,
  styleSections: false,
};
